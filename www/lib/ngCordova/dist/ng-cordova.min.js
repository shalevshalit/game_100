  ...
  angular.module("ngCordova", ["ngCordova.plugins"]), angular.module("ngCordova.plugins.actionSheet", []).factory("$cordovaActionSheet", ["$q", "$window", function (e, n) {
    ...
    return {
      getCurrentAcceleration: function () {
        ...
        var r = e.defer();
        (angular.isUndefined(navigator.accelerometer) || !angular.isFunction(navigator.accelerometer.watchAcceleration)) && r.reject("Device do not support watchAcceleration");
    ...
    return {
      preloadSimple: function (r, o) {
      ...
      }, preloadComplex: function (r, o, t, i) {
        var a = e.defer();
        return n.plugins.NativeAudio.preloadComplex(r, o, t, i, function (e) {
          a.resolve(e)
        }, function (e) {
          a.reject(e)
        }), a.promise
        ...
        var t = e.defer();
        return n.plugins.NativeAudio.play(r, o, function (e) {
          t.reject(e)
        }, function (e) {
          t.resolve(e)
        }), t.promise
